                ...
                <View style={{ marginTop: 8 }}>
                    ...
                    <ScrollView horizontal>
                        <View style={{ paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                            {groceries.map(item => (
                                <TouchableOpacity onPress={() => navigation.navigate('ProductDetails', { data: { ...item, qty: 0 } })} key={item?.id} style={{ width: screenWidth / 2.2, marginVertical: 6, backgroundColor: '#fff', borderTopLeftRadius: 14, borderTopRightRadius: 14, borderBottomLeftRadius: 14, borderBottomRightRadius: 20, overflow: 'hidden', elevation: 2 }}>
