            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                {loading ? (
                    ...
                    <View style={{ marginTop: 2 }}>
                        {addresses?.map(item => (
                            <View key={item?.id} style={{ marginTop: 9, backgroundColor: '#fff', paddingHorizontal: 8, marginHorizontal: 10, paddingVertical: 15, borderRadius: 12, flexDirection: 'row', alignItems: 'flex-start', elevation: 1, justifyContent: 'space-between' }}>
